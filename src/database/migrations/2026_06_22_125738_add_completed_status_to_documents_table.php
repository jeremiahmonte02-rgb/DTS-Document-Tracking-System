...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE documents MODIFY COLUMN status ENUM('received', 'pending_transfer', 'in_transit', 'rejected', 'cancelled') NOT NULL DEFAULT 'pending_transfer'");
    }
};
